...
```{r top 50 songs by num weeks on charts}
top_song <- data_2000 %>% 
...
ggplot(top_song, aes(x = weeks_on_chart, y = reorder(song, weeks_on_chart), color=spotify_genre_clean)) +
  geom_point() +
  ggtitle('Top 50 with Most weeks on Charts') + xlab('') + ylab('') +
  theme(plot.title = element_text(size = 16, hjust=0.5),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 12),
        legend.text = element_text(size = 12),
...
```{r top song by Num of weeks at No1}
...
ggplot(top_song_1, aes(x = n, y = reorder(song, n), color = spotify_genre_clean)) +
  geom_point() + 
  ggtitle('Top Songs with Most Weeks at No.1') + xlab('Number of Weeks') + ylab('Song Title') +
  theme(plot.title = element_text(size = 16, hjust=0.5),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 12),
        legend.text = element_text(size = 12),
...
```{r top artists by num songs on chart}
...
ggplot(top_artists, aes(x = n, y = reorder(performer, n))) +
  geom_point() +
  ggtitle('Artists with the Most Songs in Top 100') + xlab('Number of Songs') + 
  ylab('Artist') +
  theme(plot.title = element_text(size = 16, hjust=0.5),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 12),
...
```{r top artists by No1 songs on chart}
...
ggplot(top_artists_1, aes(x = n, y = reorder(performer, n))) +
  geom_point() +
  ggtitle('Artists with Most Songs at No.1') + xlab('Number of Songs') + ylab('Artist') +
  theme(plot.title = element_text(size = 16, hjust=0.5),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 12),
        legend.text = element_text(size = 12),
