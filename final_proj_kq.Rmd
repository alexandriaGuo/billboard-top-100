...
## Question: What are the musical qualities that define a popular song
## What features define popular songs
#Have the distribution of these features changed over time?
#clusters?

```{r, echo=FALSE}
df_kq <- readr::read_csv("billboard_spotify_cleaned.csv")
```
